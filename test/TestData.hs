...
{-
Separate test data from unit test implementations. Most logs are from book [1] and [2].
Every log contains result for y_L but not necessarily for every other set used within
the alpha miner.
[1]:
[2]:
-}
...
{----- flyerinstances ------}
getFlyer:: EventLog
getFlyer = [["receive flyer order","design flyer","send draft to customer","design flyer","send draft to customer","design flyer","send draft to customer",
            "print flyer","deliver flyer"],["receive flyer order","design flyer","send draft to customer","design flyer","send draft to customer","print flyer","deliver flyer"],
...
{----- posterinstances ------}
getRunEx :: EventLog
getRunEx = [["register request","examine casually","check ticket","decide","reinitiate request","examine thoroughly","check ticket","decide","pay compensation"],
...
getRunExxL = [(["check ticket"],["decide"]),(["decide"],["pay compensation","reinitiate request","reject request"]),(["decide"],["pay compensation","reinitiate request"]),
            (["decide"],["pay compensation","reject request"]),(["decide"],["pay compensation"]),(["decide"],["reinitiate request","reject request"]),
            (["decide"],["reinitiate request"]),(["decide"],["reject request"]),(["examine casually","examine thoroughly"],["decide"]),(["examine casually"],["decide"]),
            (["examine thoroughly"],["decide"]),(["register request","reinitiate request"],["check ticket"]),(["register request","reinitiate request"],["examine casually","examine thoroughly"]),
            (["register request","reinitiate request"],["examine casually"]),(["register request","reinitiate request"],["examine thoroughly"]),(["register request"],["check ticket"]),
            (["register request"],["examine casually","examine thoroughly"]),(["register request"],["examine casually"]),(["register request"],["examine thoroughly"]),(["reinitiate request"],["check ticket"]),
            (["reinitiate request"],["examine casually","examine thoroughly"]),(["reinitiate request"],["examine casually"]),(["reinitiate request"],["examine thoroughly"])]

getRunExyL :: [Transition]
getRunExyL = [(["check ticket"],["decide"]),(["decide"],["pay compensation","reinitiate request","reject request"]),(["examine casually","examine thoroughly"],["decide"]),
            (["register request","reinitiate request"],["check ticket"]),(["register request","reinitiate request"],["examine casually","examine thoroughly"])]
