...
import { Transition, AlphaminerSets } from "./MainProcessResult";

export default function AlphaMinerSetsAccordion(ams: AlphaminerSets) {
  ...
  return (
    <div>
      ...
      <Typography variant="caption">
        (There is a bug in <Latex>{"$\\KaTeX$"}</Latex> which results in 'not equal' not rendering correctly.)
      </Typography>
      <Accordion>
        <AccordionSummary
