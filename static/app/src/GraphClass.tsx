...
export default class GraphClass extends React.Component<GraphProps, GraphState> {
    ...
    componentDidMount() {
        ...
        fetch(apiURL, requestOptions)
            ...
            .then(data => this.setState({ apiResponse: data, receivedResponse: true, responseError: "" }))
            .catch(error => {
                this.setState({ apiResponse: null, receivedResponse: true, responseError: error.toString()});
                console.log("There was an error fetching from the API. Made request to: " + apiURL);
            });
    }
